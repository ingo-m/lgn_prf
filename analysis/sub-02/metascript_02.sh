...
source ${strPathPrnt}02_feat/n_02_sh_postprocess_feat.sh
date
#------------------------------------------------------------------------------
...
source ${strPathPrnt}03_anat/n_01_prepare_spm_bf_correction.sh
date

echo "---Automatic: SPM bias field correction"
/opt/spm12/run_spm12.sh /opt/mcr/v85/ batch ${strPathPrnt}03_anat/n_02_spm_bf_correction.m
date

echo "---Automatic: Postprocess bias field corrected data"
source ${strPathPrnt}03_anat/n_03_postprocess_spm_bf_correction.sh
date
...
then
  ...
  echo "   ${strPathPrnt}03_anat/pd_brain_masks/${str_sub_id}_ses-01_PD_01"
  echo "   ${strPathPrnt}03_anat/pd_brain_masks/${str_sub_id}_ses-01_PD_02"
  echo "   ..."
  echo "   Type 'go' to continue"
  read -r -s -d $'g'
  read -r -s -d $'o'
