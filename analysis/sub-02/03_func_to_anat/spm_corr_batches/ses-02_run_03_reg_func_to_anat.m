...
strPathRef = '/media/sf_D_DRIVE/MRI_Data_PhD/08_lgn_prf/derivatives/sub-02/reg_func_to_anat/ses-02/run_03/anat/';
% Directory of source image (mean functional image):
strPathSrc = '/media/sf_D_DRIVE/MRI_Data_PhD/08_lgn_prf/derivatives/sub-02/reg_func_to_anat/ses-02/run_03/mean_func/';
% Directory with other images to be registered along source image
% (functional time series):
strPathOtr = '/media/sf_D_DRIVE/MRI_Data_PhD/08_lgn_prf/derivatives/sub-02/reg_func_to_anat/ses-02/run_03/func/';
% Name of the 'SPM batch' to be created:
strPathBatch = '/media/sf_D_DRIVE/MRI_Data_PhD/08_lgn_prf/derivatives/sub-02/reg_func_to_anat/ses-02/run_03/spm_corr_batch_run_03.mat';
